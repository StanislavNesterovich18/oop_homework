...
1. `class BaseProduct`
    Родительский класс для `class Product` Определяет общую функциональность для
классов наследников.
...
4. class Smartphone
    Является классом наследником `class Product` добовляет дополнительные характеристики
в своей категории товаров
5. class LawnGrass 
    Является классом наследником `class Product` добовляет дополнительные характеристики
в своей категории товаров
